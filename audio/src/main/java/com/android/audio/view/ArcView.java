...
public class ArcView extends View {
    ...
    private static final boolean DEFAULT_ROUND_CAP = false;
    private static final float DEFAULT_RING_WIDTH = AudioUtil.dp2px(1f);
    private static final int DEFAULT_RING_COLOR = Color.parseColor("#26D59E");
    private static final int DEFAULT_RING_BACKGROUND_COLOR = Color.WHITE;
    ...
    private int measure(int measureSpec) {
        ...
        if (specMode == MeasureSpec.EXACTLY) {
            ...
            result = (int) AudioUtil.dp2px(90f);
...
//            mArcPaint.strokeCap = Paint.Cap.BUTT
    ...
    public void startRotate() {
        startRotate(2000, new LinearInterpolator());
    }
